...
import { ArrowLeft, Save, Eye, Settings, Palette, Smartphone, Monitor } from "lucide-react";
      ...
      <header className="border-b px-4 py-2 flex items-center justify-between bg-background z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            />
            <div className="text-xs text-muted-foreground">/lp/{formData.slug || "your-page-slug"}</div>
          </div>
        </div>
